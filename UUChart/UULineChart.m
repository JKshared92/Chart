...
- (void)addPoint:(CGPoint)point index:(NSInteger)index isShow:(BOOL)isHollow value:(CGFloat)value
{
    ...
    if (!_showValue) {
        ...
        UILabel *label = [[UILabel alloc]initWithFrame:CGRectMake(point.x-UUTagLabelwidth/2.0, point.y-UULabelHeight*2<0?0:point.y-UULabelHeight*2, UUTagLabelwidth, UULabelHeight)];
