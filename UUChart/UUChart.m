...
-(void)setUpChart{
	if (self.chartStyle == UUChartStyleLine) {
        ...
        if ([self.dataSource respondsToSelector:@selector(UUChartShowValues:)]) {
            [_lineChart setShowValue:[self.dataSource UUChartShowValues:self]];
        }else{
            _lineChart.showValue = NO;
        }
	...
	}else if (self.chartStyle == UUChartStyleBar)
	{
        ...
        if ([self.dataSource respondsToSelector:@selector(UUChartShowBarValues:)]) {
            [_barChart setShowValue:[self.dataSource UUChartShowBarValues:self]];
        }else {
            _barChart.showValue = NO;
        }
